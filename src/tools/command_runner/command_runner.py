# tools/command_runner/command_runner.py
import os
import json
import subprocess
import shlex
...
class CommandRunner:
    ...
    def execute(self, command: str, working_dir: Optional[str] = None, 
                interactive_responses: Optional[List[str]] = None) -> Dict[str, Any]:
...
def run_command(args: Dict[str, Any]) -> str:
    """Tool function to execute a command with the CommandRunner."""
