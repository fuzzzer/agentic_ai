...
class CommandSession:
    ...
    def __init__(self, command: str, working_dir: Optional[str] = None):
        ...
        self.process = None
        logger.info(f"Initialized CommandSession with command='{command}', working_dir='{working_dir}'")
...
class CommandRunner:
    ...
    def validate_command(self, command: str) -> Dict[str, Any]:
        ...
        for forbidden in self.forbidden_commands:
            if command.startswith(forbidden):
                ...
                return {"valid": False, "reason": f"Command starts with forbidden element: {forbidden}"}
    ...
    def validate_path(self, path: str) -> Dict[str, Any]:
        ...
        for allowed_dir in self.allowed_dirs:
            if abs_path.startswith(allowed_dir):
                logger.info(f"Path '{path}' is within allowed directory '{allowed_dir}'.")
                return {"valid": True}
    ...
    def execute(
        ...
        """
        logger.info(f"execute called with command='{command}', working_dir='{working_dir}', "
